...
int main()
{
	...
	system("COLOR E");
	printf("Sekil Olusturma Programina Hosgeldiniz. ");
	printf("\n\n");
	...
	printf("\n\n");
	printf("Lutfen ekrana cizdirmek istediginiz sekli seciniz : ");
	...
	printf("Dik ucgenin tabani kac yildiz olsun? ");
	scanf("%i",&taban);
	for(i=1;i<=taban;i++)
	{
		for(j=1;j<=i;j++)
	...
	printf("Ortadaki karakter kac yildiz olsun? ");
	scanf("%i",&orta);
	for(i=1;i<=orta;i++)
	{
		for(j=1;j<=i;j++)
	...
	printf("Ucgen kac basamakli olsun?: ");
	scanf("%i",&taban);
